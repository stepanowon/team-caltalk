    ...
    switch (message.message_type) {
      case 'schedule_request':
        return {
          ...
          badge: <Badge variant="outline" className="bg-orange-100 text-orange-800 border-orange-300">요청</Badge>,
        }
      case 'schedule_approved':
        return {
          ...
          badge: <Badge variant="outline" className="bg-green-100 text-green-800 border-green-300">승인됨</Badge>,
        }
      case 'schedule_rejected':
        return {
          ...
          badge: <Badge variant="outline" className="bg-red-100 text-red-800 border-red-300">거절됨</Badge>,
        }
    }
  }
      ...
      <div className="p-4">
        ...
        {message.related_schedule_title && (
          <div className="flex items-center gap-2 mb-2 text-sm">
            ...
            <span className="font-medium">{message.related_schedule_title}</span>
          </div>
        )}
        ...
        {isLeader && message.message_type === 'schedule_request' && message.related_schedule_id && (
          <div className="flex gap-2">
            <Button
              size="sm"
              variant="default"
              className="flex-1 bg-green-600 hover:bg-green-700"
              onClick={() => onApprove?.(message.id, message.related_schedule_id!)}
            >
            ...
            <Button
              ...
              onClick={() => onReject?.(message.id, message.related_schedule_id!)}
            >
